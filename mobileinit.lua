...
local cleanupTargets = {
    {
        path = guipath,
        label = "new.lua",
        url = "https://raw.githubusercontent.com/void2realyt/RainWare-V6-Closet-Cheat/refs/heads/main/new.lua"
    },
    {
        path = modulesPath,
        label = "6872274481.lua",
        url = "https://raw.githubusercontent.com/void2realyt/RainWare-V6-Closet-Cheat/main/games/6872274481.lua"
    },
        {
        path = mainPath,
        label = "main.lua",
...
local metaURL = bust_cache("https://api.github.com/repos/void2realyt/RainWare-V6-Closet-Cheat/contents/new.lua?ref=main")
...
local commitApiUrl = bust_cache("https://api.github.com/repos/void2realyt/RainWare-V6-Closet-Cheat/commits/main")
...
if savedCommit ~= latestCommit then
    ...
    local profiles_url = bust_cache("https://api.github.com/repos/void2realyt/RainWare-V6-Closet-Cheat/contents/profiles?ref=main")
